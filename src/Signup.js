...
const Signup = () => {
   ...
   const signUp = async () =>{
    console.log(data);
    axios.post("https://rocketgain.onrender.com/users/signup", data).then((res) => {
      console.log(res)
    ...
    return (
         ...
         <body className="dt-header--fixed theme-dark dt-layout--full-width
          dt-sidebar--fixed o-auto">
              ...
              <div className="dt-login__bg-section">
                  ...
                  <div className="dt-login__logo">
                      <a className="dt-brand__logo-link" href="">
                          <img style={{width: '300px'}} className="dt-brand__logo-img"
                             src={rocket} alt="Logo"/>
                      </a>
                  </div>
