                    ...
                    <div className='flame'>
                        <div className=' relative plus'>
                            <button onClick={() => setToggle(!toggle)} className='coc'>
                                <img src="https://oxygengainfx.com/uploads/gb-eng2.png" 
                                className='vat' alt="" />
                                <div className='flex'>
                                    <p>EN</p>
                                    <RxCaretDown />
                ...
                <div className='sap'>
                    ...
                    <div>
                        <div className="play">
                            <Maquree
                                ...
                                second="Etherum"
                                third="USDT"
                                text="Deposit your crypto and earn big return!"
                                secon="Deposit your crypto and earn big return!"
                                thir="Deposit your crypto and earn big return!"
                            ></Maquree>
                        </div>
                    </div>
                    ...
                    <div className="lal flex justify-evenly ">
                        <div className="bine">
                            ...
                            <div className="char">
                                ...
                                <div className='h-80 sup'>
                                    <h1 className='pals'>You Have no deposits change in 
                                    your account now.</h1>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="beli p-5">
                            ...
                            <p>Please add a mode of payment while depositing for ease 
                                of transacting</p>
