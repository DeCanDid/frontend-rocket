...
const Navbar = () => {
  ...
  return (
   <>
        <nav id='nav' class="navbar bg-white py-0
         fixed-top shadow px-5">
  ...
  <ul className='theUl'>
        ...
        <li>
          <Link to={"/signup"}>
           ...
           rounded-5 text-dark" type="submit">SIGN UP</button>
          </Link>
        </li>
        <li>
          <Link to='/signin'>
            <button onClick={signin} class="btn btn-primary
             rounded-5 text-dark" type="submit">SIGN IN</button>
          </Link>
        </li>
  </ul>
    ...
    aria-controls="offcanvasNavbar" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"><i className="icofont-navigation-menu fs-2"></i></span>
    </button>
